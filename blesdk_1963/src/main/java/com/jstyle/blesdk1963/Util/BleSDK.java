...
import com.jstyle.blesdk1963.constant.DeviceConst;
...
import com.jstyle.blesdk1963.model.SportPeriod;
import com.jstyle.blesdk1963.model.StepModel;
import com.jstyle.blesdk1963.model.WeatherData;
...
import static com.jstyle.blesdk1963.Util.ResolveUtil.bcd2String;
import static com.jstyle.blesdk1963.Util.ResolveUtil.getFloat;
import static com.jstyle.blesdk1963.Util.ResolveUtil.getValue;
import static com.jstyle.blesdk1963.constant.BleConst.DeviceSendDataToAPP;
...
public class BleSDK {
         ...
         /*   case DeviceConst.CMD_Set_Name:
           ...
           case DeviceConst.CMD_Set_DeviceID:
            ...
            case DeviceConst.CMD_Set_HeartbeatPackets:
                ...
                maps.put(DeviceKey.DataType, "39");
   ...
   /* public static byte[] StartHeartRateMode() {
    ...
    public static byte[] SetDeviceInfo(MyDeviceInfo deviceBaseParameter) {
        ...
        value[4] = (byte) (deviceBaseParameter.isLeft_hands() ? 0x81 : 0x80);
        value[5] = (byte) (deviceBaseParameter.isHorizontalScreen() ? 0x81 : 0x80);
        crcValue(value);
        return value;
    }
